...
type Node struct {
    ...
    Function func(ctx context.Context, state map[string]interface{}) (map[string]interface{}, error)
}
...
type Edge struct {
    ...
    To func(ctx context.Context, state map[string]interface{}) string
}
...
func (g *StateGraph) AddEdge(from, to string) {
    g.edges = append(g.edges, Edge{
        From: from,
        To: func(_ context.Context, state map[string]interface{}) string {
            return to
        },
    })
}

func (g *StateGraph) AddConditionalEdge(from string, condition func(ctx context.Context, state map[string]interface{}) string) {
    g.edges = append(g.edges, Edge{
        From: from,
        To: condition,
    })
...
func (r *Runnable) Invoke(ctx context.Context, initialState map[string]interface{}) (map[string]interface{}, error) {
